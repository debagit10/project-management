    ...
    <div>
      ...
      >
        ...
        <List className="flex gap-5">
          <ListItem
            className={active == 0 ? "bg-white text-black" : "text-white"}
            onClick={() => {
          ...
          <ListItem
            className={active == 1 ? "bg-white text-black" : "text-white"}
            onClick={() => {
          ...
          <ListItem
            className={active == 2 ? "bg-white text-black" : "text-white"}
            onClick={() => {
          ...
          <ListItem
            className={active == 3 ? "bg-white text-black" : "text-white"}
            onClick={() => {
          ...
          <ListItem
            className={active == 4 ? "bg-white text-black" : "text-white"}
            onClick={() => {
          ...
          <ListItem
            className={active == 5 ? "bg-white text-black" : "text-white"}
            onClick={() => {
